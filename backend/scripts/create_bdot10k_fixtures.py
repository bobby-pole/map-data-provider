...
def frame(feature_id: str, code: str, name: str, geometry: object) -> gpd.GeoDataFrame:
    return gpd.GeoDataFrame(
        {"idIIP": [feature_id], "x_kod": [code], "nazwa": [name]},
        geometry=[geometry],
        crs=CRS,
    )
...
def main() -> None:
    ...
    classes = {
        "OT_SKDR_L": frame(
            "PL.PZGiK.025.road-001",
            "SKDR01",
            "Fixture road",
            LineString([(500000, 250000), (500140, 250070)]),
        ),
        "OT_BUIN_L": frame(
            "PL.PZGiK.025.bridge-001",
            "BUIN01",
            "Fixture bridge",
            LineString([(500050, 250010), (500050, 250130)]),
        ),
        "OT_SWRS_L": frame(
            "PL.PZGiK.025.water-001",
            "SWRS01",
            "Fixture stream",
            LineString([(499980, 250100), (500150, 250100)]),
        ),
        "OT_BUBD_A": frame(
            "PL.PZGiK.025.building-001",
            "BUBD01",
            "Fixture building",
            Polygon([(500060, 250020), (500100, 250020), (500100, 250060), (500060, 250060)]),
        ),
        "OT_KUPG_A": frame(
            "PL.PZGiK.025.industrial-area-001",
            "KUPG01",
            "Fixture industrial area",
            Polygon([(500105, 250020), (500145, 250020), (500145, 250060), (500105, 250060)]),
        ),
        "OT_KUPG_P": frame(
            "PL.PZGiK.025.industrial-point-001",
            "KUPG01",
            "Fixture industrial point",
            Point(500125, 250080),
        ),
    }
