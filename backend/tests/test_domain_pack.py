...
def test_domain_pack_accepts_native_raster_and_remote_wms_but_rejects_unqualified_public_export(tmp_path: Path) -> None:
    ...
    manifest = {
        ...
        "artifacts": [
            {"id": "water.terrain", "kind": "native_raster", "format": "geotiff", "path": "rasters/terrain.tif", "sha256": "b06649195b8f4332ac1430d51d9fba43f94acd5189b47a4d875e8e1a4a9479dd", "source_provenance": [{"source_id": "openstreetmap", "contribution_role": "primary"}], "public_export": True},
