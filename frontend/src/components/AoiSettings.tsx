...
export function AoiSettings({ onApplied }: { onApplied: (result: ProviderRuntimeResponse) => void }) {
  ...
  return <section className="inspectorSection aoiSettings">
    ...
    <p className="muted">Power and emergency use qualified on-demand OSM acquisition, then cache a bounded provider artifact. Other categories remain visible source gaps until their domain adapters are complete.</p>
