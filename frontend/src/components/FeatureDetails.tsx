...
export function FeatureDetails({ aoiId, selected, selectedCircuit, onDetailChange, onCircuitChange }: Props) {
  ...
  if (!selected) return <section className="inspectorSection"><h2>Selected feature</h2><p className="muted">Click a visible map feature to inspect its source-backed popup and circuit membership.</p></section>;
