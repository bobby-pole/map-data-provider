      ...
      archiveLayers.forEach((layer, index) => {
        ...
        if (isLine) {
          if (layer.artifact.artifact_id === "transport.roads") {
            ...
            map.addLayer({ id, type: "line", source: sourceId, "source-layer": layer.artifact.source_layer, minzoom: 10, paint: { "line-color": "#0284c7", "line-width": 4.5, "line-opacity": 0.95 } });
            map.addLayer({ id: `${id}-labels`, type: "symbol", source: sourceId, "source-layer": layer.artifact.source_layer, minzoom: 11, filter: ["has", "name"], layout: { "symbol-placement": "line", "text-field": ["get", "name"], "text-size": 11, "text-max-angle": 35 }, paint: { "text-color": "#e0f2fe", "text-halo-color": "#0369a1", "text-halo-width": 1.5 } });
          ...
          const minzoom = (layer.domain === "emergency" || layer.domain === "gas" || layer.domain === "sewer" || layer.domain === "industrial" || layer.domain === "telecom") ? 9 : 12;
