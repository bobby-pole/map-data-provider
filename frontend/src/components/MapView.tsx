...
function featurePopupContent(feature: ProviderFeature, layer: PreviewLayer): HTMLElement {
  ...
  const fields = ["power", "man_made", "industrial", "plant:source", "generator:source", "plant:output:heat", "generator:output:heat", "tower:type", "telecom", "communication", "communication:mobile_phone", "communication:radio", "communication:television", "communication:microwave", "cable", "amenity", "healthcare", "emergency", "highway", "railway", "aeroway", "road_class", "ref", "surface", "maxspeed", "lanes", "bridge", "tunnel", "oneway", "waterway", "pipeline", "substance", "diameter", "pumping", "gas", "pressure", "official_type", "iip_identifier", "jpt_id", "version_from", "voltage", "frequency", "operator", "circuits", "cables", "wires", "plant:method", "plant:output:electricity", "start_date", "description", "phone", "contact:phone", "opening_hours", "wheelchair"]
